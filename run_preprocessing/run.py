...
def write_data_config_files(data_config_path: str, initial_temperature: np.array, duration_in_second: int,
                            dz_grid: np.array, grid_resolution: int):
    modify_arguments('!initial_temperature!', initial_temperature, data_config_path)
    modify_arguments('!end_time!', [duration_in_second], data_config_path)
